...
<section id="buttons" class="d-flex justify-content-center align-items-center my-5">
    <button id="listproducts" class="mx-2 btn btn-normal">Get ALL</button>
    <button id="listmains" class="mx-2 btn btn-normal">Get Mains</button>
    <button id="listbranches" class="mx-2 btn btn-normal">Get Branches</button>
