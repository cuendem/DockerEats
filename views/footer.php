    ...
    <div class="row">
        ...
        <div class="col-xl-8 row footerUpper d-flex justify-content-between gap-5">
            ...
            <div class="footerLast px-0">
                <ul>
                    <li class="footerLinkListHead">Support</li>
                    <li><a href="#">FAQ</a></li>
                    <li><a href="#">Contact Us</a></li>
                </ul>
                <ul>
                    <li class="footerLinkListHead">Languages</li>
