...
<main>
    <section id="banner" class="container-fluid text-center mt-5">
        ...
        <div class="bannerContainer mt-5 position-relative overflow-hidden">
            <img src="/img/TupperContainer.png" class="undraggable position-absolute top-0 start-50 translate-middle-x"  alt="DockerEats Container">
        </div>
    </section>
    ...
    <section id="whatis" class="container-fluid wave-separator">
        ...
        <div class="whatisBody row gy-5 mt-3">
            ...
            <div class="whatisImage col-xl-6 position-relative overflow-hidden">
                <img src="/img/TupperContainer.png" class="undraggable position-absolute" alt="DockerEats Container">
            </div>
        </div>
    ...
    <section id="whyorder" class="container-fluid wave-separator">
        ...
        <div class="row mt-1 mx-3 d-flex gy-5 gx-0">
            <div class="card review mx-auto col-lg-12 col-xxl-4">
                <div class="row g-0">
                    <div class="col-3 p-3 rounded">
                        <img src="/img/products/product1.png" class="img-fluid" alt="Jeremy Elbertson">
                    </div>
            ...
            <div class="card review mx-auto col-lg-12 col-xxl-4">
                <div class="row g-0">
                    <div class="col-3 p-3 rounded">
                        <img src="/img/products/product2.png" class="img-fluid" alt="Jeremiah Albert Jr.">
                    </div>
                    <div class="col-9 d-flex align-items-center">
                        <div class="card-body">
            ...
            <div class="card review mx-auto col-lg-12 col-xxl-4">
                <div class="row g-0">
                    <div class="col-3 p-3 rounded">
                        <img src="/img/products/product3.png" class="img-fluid" alt="José Alberto Olivares">
                    </div>
                    <div class="col-9 d-flex align-items-center">
                        <div class="card-body">
        ...
        <div class="siteNumbers row text-center mt-1 g-5">
            <div class="col-md-4">
                <h3>5K+</h3>
                <p>customers</p>
            </div>
    ...
    <section id="getstarted" class="container-fluid wave-separator">
        ...
        <div class="row mt-3 g-5">
            <div class="col-lg-6 col-xl-4">
                ...
                <a href="#" class="arrow">Our containers ➜</a>
            </div>
            <div class="col-lg-6 col-xl-4">
                ...
                <h5>Check our list of ingredients</h5>
                <p>You can add or remove ingredients from your parts for maximum customization! We also have a list of allergens.</p>
                <a href="#" class="arrow">Our ingredients ➜</a>
            </div>
            <div class="col-lg-6 col-xl-4">
                ...
                <a href="#" class="arrow">Our promotions ➜</a>
            </div>
        </div>
