...
<section id="getstarted" class="container-fluid wave-separator">
    ...
    <div class="row mt-3 g-5">
        ...
        <div class="col-lg-6 col-xl-4">
            ...
            <p>Much like our global users, our food does not belong to a single ethnicity or type. We gladly cook and serve all kinds of dishes!</p>
        ...
        <div class="col-lg-6 col-xl-4">
            ...
            <a href="/promotions/" class="arrow">Our promotions ➜</a>
        </div>
    </div>
