    ...
    <div class="row">
        <form action="" method="POST" enctype="multipart/form-data" class="d-flex flex-column align-items-center gap-3 mx-auto col-8 col-md-6 col-lg-4">
            ...
            <div class="inputDiv position-relative">
                <input type="text" value="<?=$_SESSION['username']?>" name="username" id="username" required placeholder=" " autocomplete="off" accept="image/jpeg, image/jpg, image/png, image/gif, image/webp">
